...
public class ObterRelatorio {

	private static final String DEFAULT_DESCRIPTION = "Teste Automatizado";
	private static final String DEFAULT_PATH = "./Relatorio/obterRelatorio_%s.html";
